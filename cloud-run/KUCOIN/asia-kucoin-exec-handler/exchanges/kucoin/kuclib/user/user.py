...
class UserData(KucoinBaseRestApi):
    ...
    async def get_transferable(self, currency, account_type, **kwargs):
        """
    ...
    async def get_sub_user_page(self, **kwargs):
        """
        ...
        if kwargs:
            params.update(kwargs)
        return await self._request('GET', '/api/v2/sub/user', params=params)

    async def get_account_summary_info(self):
        """
        ...
        """
        return await self._request('GET', '/api/v2/user-info')

    async def create_sub_account(self, password, sub_name, access, **kwargs):
        """
        ...
        return await self._request('POST', '/api/v2/sub/user/created', params=params)

    async def get_sub_account_api_list(self, sub_name, **kwargs):
        """
        ...
        if kwargs:
            params.update(kwargs)
        return await self._request('GET', '/api/v1/sub/api-key', params=params)

    async def create_apis_for_sub_account(self, sub_name, passphrase, remark, **kwargs):
        """
        ...
        return await self._request('POST', '/api/v1/sub/api-key', params=params)

    async def modify_sub_account_apis(self, sub_name, api_key, passphrase, **kwargs):
        """
        ...
        return await self._request('POST', '/api/v1/sub/api-key/update', params=params)

    async def delete_sub_account_apis(self, sub_name, api_key, passphrase):
        """
        ...
        return await self._request('DELETE', '/api/v1/sub/api-key', params=params)

    async def get_sub_account_page_info(self, **kwargs):
        """
        ...
        if kwargs:
            params.update(kwargs)
        return await self._request('GET', '/api/v2/sub-accounts', params=params)

    async def get_hf_account_ledgers(self, **kwargs):
        """
        ...
        if kwargs:
            params.update(kwargs)
        return await self._request('GET', '/api/v1/hf/accounts/ledgers', params=params)

    async def transfer_to_hf_account(self, client_oid, currency, from_payer, amount):
        """
        ...
        await self._request('POST', '/api/v2/accounts/inner-transfer', params=params1)
        params2 = {
            'currency': currency,
            'type': 'trade_hf'
        }
        return await self._request('GET', '/api/v1/accounts', params=params2)
