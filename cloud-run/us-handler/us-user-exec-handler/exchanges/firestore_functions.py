...
async def change_executed_status_tp_sl(account_id, trade_id, document_id, is_tp_or_sl):
    ...
    if is_tp_or_sl == "sl":
        sl_doc_ref = db.collection(COLLECTION_USERS).document(account_id).collection(COLLECTION_TRADES).document(
...
async def get_tp_sl_orders(account_id, trade_id):
    ...
    tp_collection = db.collection(COLLECTION_USERS).document(account_id).collection(COLLECTION_TRADES).document(
    ...
    sl_collection = db.collection(COLLECTION_USERS).document(account_id).collection(COLLECTION_TRADES).document(
