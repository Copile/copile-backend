...
CLOUD_RUN_SERVICE_URL1 = 'https://' + region + '-trader-track-handler-' + 'zvakwy7kgq-' + short + '.a.run.app'
CLOUD_RUN_SERVICE_URL2 = 'https://' + region + '-trader-exec-handler-' + 'zvakwy7kgq-' + short + '.a.run.app'
