...
async def bulk_order(data: dict):
    ...
    try:
        ...
        for sl_data in stop_losses:
            await bybit.stoploss.send_stoploss(account_id, trade_id, sl_data['sl_id'], sl_data['sl_number'], sl_data['sl_value'], sl_data['sl_percentage'], float(trade_info["quantity"]), trade_info, precision, keys)
