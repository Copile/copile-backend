...
async def trade_order(self,
    ...
    '''
    res = await self.post("/openApi/swap/v2/trade/order", params={
        "symbol":       symbol,
        "type":         type,
        "side":         side,
...
async def cancel_order(self,
    ...
    '''
    res = await self.delete("/openApi/swap/v2/trade/order", params={
        "orderId":    orderId,
        "symbol":     symbol,
        "recvWindow": recvWindow,
    })
...
async def cancel_orders(self,
    ...
    '''
    res = await self.delete("/openApi/swap/v2/trade/batchOrders", params={
        "symbol":      symbol,
...
async def cancel_all_orders(self,
    ...
    '''
    res = await self.post("/openApi/swap/v2/trade/allOpenOrders", params={
        "symbol":     symbol,
        "recvWindow": recvWindow,
    })
...
async def current_orders(self,
    ...
    '''
    res = await self.get("/openApi/swap/v2/trade/openOrders", params={
        "symbol":     symbol,
        "recvWindow": recvWindow,
    })
...
async def order(self,
    ...
    '''
    res = await self.get("/openApi/swap/v2/trade/order", params={
        "symbol":     symbol,
        "orderId":    orderId,
        "recvWindow": recvWindow,
    })
...
async def switch_margin_mode(self,
    ...
    '''
    res = await self.post("/openApi/swap/v2/trade/marginType", params={
        "symbol":     symbol,
...
async def switch_leverage(self,
    ...
    '''
    res = await self.post("/openApi/swap/v2/trade/leverage", params={
        "symbol":     symbol,
        "side":       side,
        "leverage":   leverage,
        "recvWindow": recvWindow,
