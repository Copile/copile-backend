...
CLOUD_RUN_SERVICE_URL = 'https://' + region + "-trader-track-handler-" + "zvakwy7kgq-" + short + ".a.run.app"
...
async def create_task(account_id, trade_id, document_id, payload, endpoint):
